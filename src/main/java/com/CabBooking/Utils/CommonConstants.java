...
public class CommonConstants {
    ...
    public static final String IP = "localhost"; // TODO: Change before demo
    public static final String PORT = "27017";
    public static final String DATABASE = "CabBookingDB";
    public static final int DIST_PER_TIME = 10; // TODO: Decrease slightly before demo
    public static final int PRICE_PER_SECOND = 50;
