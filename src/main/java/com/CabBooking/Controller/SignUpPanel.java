...
class SignUpPanel extends BackgroundPanel {
    ...
    private void createUIComponents() {
        ...
        final TextLabel userMobileText = new TextLabel(200, 400, 300, 40, Color.WHITE, "Mobile number", CommonConstants.LAUNCH_MSG_FONT_SIZE - 5);
        ...
        passwordFormatLabel = new TextLabel(200, 364, 300, 30, Color.RED, passwordFormatError, 10);
